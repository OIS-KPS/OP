...
<body class="bg-[#F8FAFC] text-slate-800 antialiased font-sans">
    ...
    <div id="addSupervisorModal" class="hidden fixed inset-0 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center z-50 p-4">
        <div class="bg-white rounded-2xl border border-slate-200 shadow-2xl max-w-md w-full overflow-hidden p-6 space-y-4">
            <h3 class="text-base font-bold text-slate-900">Add Company Supervisor</h3>
            <form action="users.php" method="POST" class="space-y-3 text-xs">
                ...
                <div class="flex justify-end gap-2 pt-3">
                    ...
                    <button type="submit" class="px-5 py-2 bg-[#0F2854] hover:bg-blue-900 text-white rounded-xl font-semibold cursor-pointer">Save Supervisor</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="addCompanyModal" class="hidden fixed inset-0 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center z-50 p-4">
        <div class="bg-white rounded-2xl border border-slate-200 shadow-2xl max-w-md w-full overflow-hidden p-6 space-y-4">
            <h3 class="text-base font-bold text-slate-900">Add Partner Company</h3>
            <form action="users.php" method="POST" class="space-y-3 text-xs">
                <input type="hidden" name="action" value="create_company">
                <div>
                    <label class="block font-semibold text-slate-700 mb-1">Company Name</label>
                ...
                <div>
                    ...
                    <input type="text" name="department" placeholder="e.g., IT Department" class="w-full bg-slate-50 border border-slate-200 rounded-xl p-2.5 focus:outline-none focus:border-[#0F2854]">
                </div>
                <div class="flex justify-end gap-2 pt-3">
                    ...
                    <button type="submit" class="px-5 py-2 bg-[#0F2854] hover:bg-blue-900 text-white rounded-xl font-semibold cursor-pointer">Save Company</button>
                </div>
            </form>
        </div>
    </div>
