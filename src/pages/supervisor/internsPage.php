            ...
            <main class="p-6 max-w-7xl w-full mx-auto space-y-5 flex-1">
                ...
                <div class="bg-white rounded-2xl border border-slate-200/80 shadow-xs overflow-hidden">
                    <div class="p-4 px-5 border-b border-slate-100">
                        ...
                        <p class="text-slate-400 text-[11px] mt-0.5">Track accomplishment report progress for each student</p>
                    </div>
                            ...
                            <tbody class="divide-y divide-slate-100 text-slate-700 text-xs">
                                <?php foreach ($interns as $intern): ?>
                                    <?php 
                                        ...
                                        $target = 10; // Default 10 weeks target
                                    ...
                                    <tr class="hover:bg-slate-50/80 transition-colors">
                                        ...
                                        <td class="py-3 px-5">
                                            <div class="flex items-center gap-3">
                                                <div class="w-8 h-8 rounded-full bg-[#0F2854]/10 text-[#0F2854] flex items-center justify-center font-bold text-xs shrink-0">
