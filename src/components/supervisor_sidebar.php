...
<aside class="w-64 bg-white border-r border-slate-200 flex flex-col justify-between shrink-0 h-screen sticky top-0 z-20">
        ...
        <nav class="p-4 space-y-4">
            ...
            <div>
                ...
                <div class="space-y-1">
                    ...
                    <a href="review_reports.php" class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl transition-all text-xs <?= $isReview ? 'bg-blue-50/80 text-[#0F2854] font-bold border-l-4 border-[#0F2854] shadow-xs' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900 font-medium' ?>">
                    ...
                    <!-- Evaluate Students -->
                    <?php $isEvaluate = ($currentPage === 'evaluate_students.php' || $currentPage === 'evaluate_form.php'); ?>
                    <a href="evaluate_students.php" class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl transition-all text-xs <?= $isEvaluate ? 'bg-blue-50/80 text-[#0F2854] font-bold border-l-4 border-[#0F2854] shadow-xs' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900 font-medium' ?>">
    ...
    <!-- Bottom Logout (Matches Student UI Exactly) -->
