<?php
// src/services/cqi_dashboard_data.php
// Shared CQI dashboard data builder. Included by coordinator/dashboard.php and
// coordinator/export_cqi.php. Expects an active $pdo connection in scope.
